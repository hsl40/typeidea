# Generated by Django 2.2.10 on 2020-03-04 15:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('category', models.ForeignKey(on_delete=models.SET(blog.models.get_default_category), to='blog.Category', verbose_name='分类')),
                ('owner', models.ForeignKey(on_delete=models.SET(blog.models.get_default_user), to=settings.AUTH_USER_MODEL, verbose_name='作者')),
